...
jack_tp_2023_nc <- nc_open('jack_tp_2023.nc')
jack_u10_2023_nc <- nc_open('jack_u10_2023.nc')
jack_v10_2023_nc <- nc_open('jack_v10_2023.nc')
jack_tp_2023 <- as.vector(nc.get.var.subset.by.axes(jack_tp_2023_nc, "tp", axis.indices=list(X=1,Y=1)))
...
orla_tp_2023_nc <- nc_open('orla_tp_2023.nc')
orla_u10_2023_nc <- nc_open('orla_u10_2023.nc')
orla_v10_2023_nc <- nc_open('orla_v10_2023.nc')
orla_tp_2023 <- as.vector(nc.get.var.subset.by.axes(orla_tp_2023_nc, "tp", axis.indices=list(X=1,Y=1)))
...
fort_tp_2023_nc <- nc_open('fort_tp_2023.nc')
fort_u10_2023_nc <- nc_open('fort_u10_2023.nc')
fort_v10_2023_nc <- nc_open('fort_v10_2023.nc')
fort_tp_2023 <- as.vector(nc.get.var.subset.by.axes(fort_tp_2023_nc, "tp", axis.indices=list(X=1,Y=1)))
